...
# URL directa de tu logo en GitHub para máxima compatibilidad
...
# Usamos v=9 para asegurar que el móvil detecte un cambio y actualice el icono
components.html(
    f"""
    <script>
        const link = parent.document.createElement('link');
        link.rel = 'manifest';
        link.href = './manifest.json?v=9';
